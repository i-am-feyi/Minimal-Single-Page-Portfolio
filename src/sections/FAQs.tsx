      ...
      <div className="container">
        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {faqs.map(({ question, answer }) => (
            <div
              key={question}
              className="py-6 md:py-8 lg:py-10 border-t border-stone-400 border-dotted last:border-b"
            >
              <div className="flex justify-between items-center gap-4">
                <div className="text-2xl md:text-3xl lg:text-4xl">
                  {question}
                </div>
                <div className="inline-flex items-center justify-center size-11 md border border-stone-400 rounded-full shrink-0">
                  <svg
